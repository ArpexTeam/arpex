    ...
    <section className="bg-black relative top-20 h- w-full">
        ...
        <div className='bg-[#151515] w-full mt-10'>
            <form onSubmit={handleSubmit} className='md:grid flex flex-col justify-center items-center md:grid-cols-2 text-center py-14'>
                ...
                <input id="nameContact" name='from_name' type='text' maxLength="50" className='focus:outline-none focus:border-gray-400 focus:border-2 rounded-md p-2 bg-input-opacity border-b-2 border-b-pink-rgb'/>
                </div>
                ...
                <input id="lastNameContact" name='from_lastName' maxLength="50" type='text' className='focus:outline-none focus:border-gray-400 focus:border-2 rounded-md p-2 w- bg-input-opacity border-b-2 border-b-pink-rgb'/>
                </div>

                <div className='md:ml-auto md:mr-4 flex text-[#8F8F8F] text-[15px] font-["Roboto-Regular"] flex-col justify-start w-4/5 sm:w-1/2'>
                <label for="emailContact" className='w-fit mt-8'>E-Mail</label>
                <input id="emailContact" type='text' name='from_email' maxLength="60" className='focus:outline-none focus:border-gray-400 focus:border-2 rounded-md p-2  bg-input-opacity border-b-2 border-b-pink-rgb'/>
                </div>
                
                <div className='flex md:ml-4 text-[#8F8F8F] text-[15px] font-["Roboto-Regular"] flex-col justify-start w-4/5 sm:w-1/2'>
                <label for="phoneContact" className='w-fit mt-8'>Telefone com DDD</label>
                <input id="phoneContact" type='text' value={phone} onChange={formatNumber} name='from_phone' maxLength="15" className='focus:outline-none focus:border-gray-400 focus:border-2 rounded-md p-2 bg-input-opacity border-b-2 border-b-pink-rgb'/>
                </div>
