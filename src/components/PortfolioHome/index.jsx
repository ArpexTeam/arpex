...
function PortifolioHome(){
    return(
        <div className="w-full bg-[#101010] pt-44 pb-12 ">
            <div className="w-4/5 ml-auto mr-auto max-w-[1280px]">
                <div className='text-left'>
                <h1 className="text-[48px] font-['Roboto-Bold'] text-pink-rgb">Nossos projetos</h1>
                ...
                <p className="text-[20px] font-['Roboto-Medium'] text-white">Conheça mais projetos</p>
                </div>
                </div>
                <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 justify-between">
                    <div className="w-full h-96 bg-gray-500 rounded-md"></div>
                    <div className="w-full h-96 bg-gray-500 rounded-md"></div>
                    <div className="w-full h-96 bg-gray-500 rounded-md"></div>
